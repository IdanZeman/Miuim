          ...
          var __webpack_modules__ = {
            ...
            "./packages/@logrocket/exceptions/src/raven/FunctionPropertyMirror.js": (
              ...
              (function(__unused_webpack_module, exports2, __webpack_require__2) {
                ...
                var DEFAULT_RESERVED_PROPS = /* @__PURE__ */ new Set(["prototype", "length", "name", "arguments", "caller", "__lr__", "__lr_wrapper__", "__inner__", "__refreshMirroredProps__"]);
                function isSymbol(prop) {
                  return (0, _typeof2.default)(prop) === "symbol";
                }
                var FunctionPropertyMirror = (function() {
                  function FunctionPropertyMirror2(source, target) {
                    var _ref = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : {}, hasKey = _ref.hasKey, _ref$reservedProps = _ref.reservedProps, reservedProps = _ref$reservedProps === void 0 ? DEFAULT_RESERVED_PROPS : _ref$reservedProps, _ref$includeSymbols = _ref.includeSymbols, includeSymbols = _ref$includeSymbols === void 0 ? true : _ref$includeSymbols;
                    (0, _classCallCheck2.default)(this, FunctionPropertyMirror2);
                    this.source = source;
                    this.target = target;
                    ...
                    this.mirroredProps = /* @__PURE__ */ Object.create(null);
                    this.descriptorCache = /* @__PURE__ */ Object.create(null);
                  }
                  (0, _createClass2.default)(FunctionPropertyMirror2, [{
                    key: "isReserved",
                    ...
                    value: function getDescriptor(prop) {
                      if (Object.prototype.hasOwnProperty.call(this.descriptorCache, prop)) {
                        return this.descriptorCache[prop] || void 0;
                      }
                      var descriptor;
                      try {
                    ...
                    value: function defineMirroredDescriptor(prop, descriptor) {
                      ...
                      Object.defineProperty(this.target, prop, {
                        ...
                        set: writable === false ? void 0 : function(value) {
                  ...
                  return FunctionPropertyMirror2;
                })();
                exports2["default"] = FunctionPropertyMirror;
              })
            ),
            /***/
            "./packages/@logrocket/exceptions/src/raven/raven.js": (
              ...
              (function(__unused_webpack_module, exports2, __webpack_require__2) {
                ...
                var _FunctionPropertyMirror = _interopRequireDefault(__webpack_require__2(
                  /*! ./FunctionPropertyMirror */
                  "./packages/@logrocket/exceptions/src/raven/FunctionPropertyMirror.js"
                ));
                ...
                var Handler = (function() {
                  ...
                  (0, _createClass2.default)(Handler2, [{
                    ...
                    value: function wrap(options, func, _before) {
                      ...
                      var reflect = (typeof Reflect === "undefined" ? "undefined" : (0, _typeof2.default)(Reflect)) === "object" ? Reflect : void 0;
                ...
                function registerFetch(_ref) {
                  ...
                  var unregister = _fetchIntercept.default.register({
                    ...
                    response: function response(fetchId, _response) {
                      ...
                      if (((_response$headers = _response.headers) === null || _response$headers === void 0 ? void 0 : _response$headers.get("content-type")) === "text/event-stream") {
                        responseTextPromise = Promise.resolve("LogRocket skipped consuming an event-stream body.");
                      } else if (contentTypeIsBinary((_response$headers2 = _response.headers) === null || _response$headers2 === void 0 ? void 0 : _response$headers2.get("content-type"))) {
                        ...
                        try {
                          ...
                          var responseHash = {
                            url: _response.url,
                            responseType: (_response$type = _response.type) === null || _response$type === void 0 ? void 0 : _response$type.toUpperCase(),
                      ...
                      responseTextPromise.catch(function(error) {
                        ...
                        var responseHash2 = {
                          url: _response.url,
                          responseType: (_response$type2 = _response.type) === null || _response$type2 === void 0 ? void 0 : _response$type2.toUpperCase(),
                          status: _response.status,
                          headers: stringifyHeaders(_response.headers),
                          body: data,
                          method: fetchMethodMap[fetchId]
            ...
            "./packages/@logrocket/network/src/registerXHR.js": (
              ...
              (function(__unused_webpack_module, exports2, __webpack_require__2) {
                ...
                var _statusCodes = __webpack_require__2(
                  /*! @logrocket/utils/src/constants/statusCodes */
                  "./packages/@logrocket/utils/src/constants/statusCodes.ts"
                );
                var _parseRawHeaders = __webpack_require__2(
                  /*! @logrocket/utils/src/parseRawHeaders */
                ...
                function registerXHR(_ref) {
                  ...
                  XMLHttpRequest = function XMLHttpRequest2(mozAnon, mozSystem) {
                    ...
                    var captureResponse = function captureResponse2() {
            ...
            "./packages/@logrocket/utils/src/constants/statusCodes.ts": (
              ...
              (function(__unused_webpack_module, exports2, __webpack_require__2) {
                ...
                exports2.getStatusText = getStatusText;
                exports2.XHR_CUSTOM_FAILURE_STATUSES = exports2.XHR_CUSTOM_STATUS_CODES = exports2.STATUS_CODES = void 0;
                var _defineProperty2 = _interopRequireDefault(__webpack_require__2(
                  /*! @babel/runtime/helpers/defineProperty */
                  "./node_modules/@babel/runtime/helpers/defineProperty.js"
                ));
                ...
                exports2.STATUS_CODES = STATUS_CODES;
                ...
                exports2.XHR_CUSTOM_STATUS_CODES = XHR_CUSTOM_STATUS_CODES;
                ...
                exports2.XHR_CUSTOM_FAILURE_STATUSES = XHR_CUSTOM_FAILURE_STATUSES;
            ...
            "./packages/@logrocket/utils/src/createUnsubListener.ts": (
              ...
              (function(__unused_webpack_module, exports2, __webpack_require__2) {
                ...
                exports2.createUnsubListener = createUnsubListener;
            ...
            "./packages/@logrocket/utils/src/enhanceFunc.ts": (
              ...
              (function(__unused_webpack_module, exports2, __webpack_require__2) {
                ...
                var _createUnsubListener = __webpack_require__2(
                  /*! ./createUnsubListener */
                  "./packages/@logrocket/utils/src/createUnsubListener.ts"
                );
            ...
            "./packages/@logrocket/utils/src/parseRawHeaders.ts": (
              ...
              (function(__unused_webpack_module, exports2, __webpack_require__2) {
                ...
                exports2.parseRawHeaders = void 0;
                var _defineProperty2 = _interopRequireDefault(__webpack_require__2(
                  /*! @babel/runtime/helpers/defineProperty */
                  "./node_modules/@babel/runtime/helpers/defineProperty.js"
                ));
                ...
                var parseRawHeaders = function parseRawHeaders2(raw) {
                  var config = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {};
                ...
                exports2.parseRawHeaders = parseRawHeaders;
              })
            ),
            /***/
            "./packages/@logrocket/utils/src/protectFunc.ts": (
            ...
            "./packages/@logrocket/utils/src/sendTelemetryData.js": (
              ...
              (function(__unused_webpack_module, exports2, __webpack_require__2) {
                ...
                var SCRIPT_VERSION = true ? "f36d797919b846d5c70910b8863744a9baf17f3d" : 0;
            ...
            "./packages/logrocket/src/LogRocket.js": (
              ...
              (function(__unused_webpack_module, exports2, __webpack_require__2) {
                ...
                var _sendTelemetryData = _interopRequireDefault(__webpack_require__2(
                  /*! @logrocket/utils/src/sendTelemetryData */
                  "./packages/@logrocket/utils/src/sendTelemetryData.js"
                ));
                function ownKeys(object, enumerableOnly) {
                  var keys = Object.keys(object);
                ...
                var LogRocket = (function() {
                  ...
                  (0, _createClass2.default)(LogRocket2, [{
                    ...
                    value: function init(appID) {
                      var _window, _window$Zone, _window2, _window2$Zone, _window2$Zone$current, _this2 = this;
            ...
            "./packages/logrocket/src/makeLogRocket.js": (
              ...
              (function(__unused_webpack_module, exports2, __webpack_require__2) {
                ...
                function makeLogRocket() {
                  ...
                  var getNoopPolyfill = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : makeNoopPolyfill;
                  var getInstance = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : function() {
            ...
            "./packages/logrocket/src/setup.js": (
              ...
              (function(__unused_webpack_module, exports2, __webpack_require__2) {
                ...
                exports2.getDomainsAndEnv = getDomainsAndEnv;
                exports2.setupBaseSDKCONFIG = setupBaseSDKCONFIG;
                ...
                function setup() {
                  var _ref = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : {}, enterpriseServer = _ref.enterpriseServer, _ref$sdkVersion = _ref.sdkVersion, sdkVersion = _ref$sdkVersion === void 0 ? "11.0.0" : _ref$sdkVersion, opts = (0, _objectWithoutProperties2.default)(_ref, ["enterpriseServer", "sdkVersion"]);
