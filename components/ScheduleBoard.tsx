            ...
            <div className="fixed inset-0 bg-slate-900/60 backdrop-blur-sm z-[100] flex items-center justify-center p-2 md:p-4 animate-fadeIn">
                <div className="bg-white rounded-xl md:rounded-2xl shadow-2xl w-full max-w-4xl overflow-hidden flex flex-col max-h-[95vh] md:max-h-[85vh]">
                    ...
                    <div className="flex-1 overflow-hidden flex flex-col">
                        {/* Assigned People Section - Always visible */}
                        ...
                        {/* Available People Section - Only for non-viewers */}
                        {!isViewer && (
        ...
        <div className="flex flex-col gap-8">
                ...
                <div className="rounded-xl border-2 border-red-500 bg-red-50 p-3 md:p-4 space-y-2 md:space-y-3 animate-fadeIn">
                    ...
                    <ul className="space-y-2">
                        {mismatchWarnings.map((w, i) => (
                            <li
                                key={w.warningId}
                                className="text-xs md:text-sm flex flex-col gap-2 bg-white/60 rounded-md p-2 md:px-3 md:py-2 border border-red-300 transition-all"
                            >
                                <div
                                    onClick={() => handleJumpToShift(w.shiftId, w.start)}
                                    className="flex-1 flex flex-col gap-1 cursor-pointer hover:bg-white/80"
                                >
                                    ...
                                    <div className="flex flex-wrap items-center gap-2 text-slate-600">
                                        <span className="font-medium text-xs">
                                            📅 {w.start.toLocaleDateString('he-IL', { day: '2-digit', month: '2-digit' })}
                                        </span>
                                ...
                                <button
                                    ...
                                    className="flex items-center justify-center gap-1 px-3 py-1.5 rounded-full bg-green-600 hover:bg-green-700 text-white text-xs font-bold transition-colors whitespace-nowrap"
                                    title="אישור"
                                >
                                    <CheckCircle size={14} />
                                    אישור
            ...
            <div className="bg-white rounded-xl shadow-portal p-3 md:p-6">
                ...
                <div className="flex flex-col gap-3 md:gap-4 mb-4 md:mb-6">
                    ...
                    {/* Bottom Row: Actions + Date Navigation */}
