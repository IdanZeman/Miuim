        ...
        <div className="min-h-screen bg-gradient-to-br from-emerald-50 via-white to-yellow-50">
            ...
            <div className="container mx-auto px-4 py-16">
                ...
                <div className="text-center mb-16">
                    <div className="inline-flex items-center gap-3 bg-white shadow-lg px-6 py-3 rounded-full mb-8 border-2 border-yellow-400">
                        ...
                        <h1 className="text-3xl font-bold text-slate-800">Miuim</h1>
                    </div>
