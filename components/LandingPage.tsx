                    ...
                    <div className="grid lg:grid-cols-2 gap-8 md:gap-12 items-center">
                        ...
                        <div className="text-center lg:text-right space-y-4 md:space-y-8 animate-in fade-in slide-in-from-right duration-700 order-2 lg:order-1">
                            ...
                            <div className="flex flex-col sm:flex-row gap-3 md:gap-4 justify-center lg:justify-start">
                                ...
                                <button className="bg-white text-slate-700 px-6 md:px-8 py-3 md:py-4 rounded-xl font-bold text-base md:text-lg border-2 border-slate-200 hover:border-green-500 hover:shadow-lg transition-all duration-300">
                                    צפה בהדגמה
                                </button>
                            </div>
