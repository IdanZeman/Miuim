...
import { Calendar, Clock, CheckCircle2, XCircle, ChevronRight, ChevronLeft, Save, User, ChevronDown, Search } from 'lucide-react';
                ...
                <div className="flex items-center gap-4">
                    <div className="relative">
                        ...
                        <input
                            ...
                            className="pl-4 pr-10 py-2 rounded-full border border-slate-300 text-sm focus:outline-none focus:ring-2 focus:ring-idf-green focus:border-transparent"
                        />
                    </div>
                        ...
                        <div key={team.id} className="bg-white rounded-xl shadow-portal overflow-hidden border border-slate-100">
                            ...
                            >
                                ...
                                <button className="text-slate-400">
                                    {collapsedTeams.has(team.id) ? <ChevronRight size={20} className="rotate-180 md:rotate-0" /> : <ChevronDown size={20} />}
                                </button>
                            </div>
