...
export const SystemMessagePopup: React.FC<{ messages?: SystemMessage[] }> = ({ messages: propMessages }) => {
    ...
    const checkMessages = async () => {
        try {
            ...
            if (messagesError) console.error('Error fetching popup messages:', messagesError);

            // Use props if provided, otherwise fallback to fetched messages
            if (!data) data = fetchedMessages;
