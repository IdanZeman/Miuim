            ...
            <div className="flex flex-col lg:flex-row gap-6 lg:gap-8 items-start">
                ...
                <div className="flex-1 min-w-0 w-full space-y-6">
                    ...
                    {activeShift ? (
                        ...
                        <div className="bg-white rounded-[2rem] shadow-xl md:shadow-portal border border-slate-100 p-6 md:p-8 relative overflow-hidden">
                                ...
                                {upcomingShifts.map((shift, idx) => {
                                    ...
                                    return (
                                        <div
                                            ...
                                            className="group flex items-center gap-4 bg-white rounded-2xl p-4 border border-slate-200 hover:border-blue-300 shadow-sm hover:shadow-md transition-all cursor-pointer"
                                        >
                                            <div className={`w-12 h-12 rounded-xl flex flex-col items-center justify-center flex-shrink-0 shadow-sm border ${isToday ? 'bg-blue-600 text-white border-blue-600' : 'bg-slate-50 text-slate-600 border-slate-100'}`}>
                                            ...
                                            <div className="flex-1 min-w-0">
                                                <h4 className="font-semibold text-slate-900 truncate group-hover:text-blue-700 transition-colors">{shift.task?.name}</h4>
                                            ...
                                            <div className="h-8 w-1 rounded-full" style={{ backgroundColor: shift.task?.color || '#cbd5e1' }}></div>
                                        </div>
                                    );
                                })}
                            </div>
