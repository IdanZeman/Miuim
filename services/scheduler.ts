...
interface AlgoUser {
  ...
  loadScore: number; // Total duration * difficulty assigned
  shiftsCount: number;
}
 ...
 */
const initializeUsers = (people: Person[], targetDate: Date): AlgoUser[] => {
...
export const solveSchedule = (
  ...
  const algoUsers = initializeUsers(people, startDate);
